...
public class ActionClassTest extends TestBase {
    ...
    public void ciftTiklama(){
        ...
        Actions actions = new Actions(driver);
        //Bir webelemente cift tiklamak icin doubleClick(button) methodu kullanilir
    ...
    public void hoverOver(){
        ...
        Actions actions = new Actions(driver);
        //mouse'u istenilen webelementin üstüne götürmek icin
        //moveToElement(menu) methodu kullanilir
    ...
    public void buyukKucukYazma(){
        ...
        Actions actions = new Actions(driver);
        actions.moveToElement(aramaKutusu).click().keyDown(Keys.SHIFT)
                .sendKeys("merhaba").keyUp(Keys.SHIFT).sendKeys(" nasilsiniz").perform();
